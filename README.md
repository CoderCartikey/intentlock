...
tests/                     40 automated safety and integration tests
...
Current suite: **40 tests** covering policy, AI failures, prompt injection, recurring pricing, audit storage, signed authorization, tampering, expiration, replay protection and Razorpay request construction.
